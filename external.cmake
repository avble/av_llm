...
if (AV_LLM_USE_SYSTEM_CURL STREQUAL "OFF")
	...
	if(NOT curl_POPULATED)
		...
		#message("[curl][debug] ${CURL_LIBRARY} - ${CURL_INCLUDE_DIRS}")
	endif()
		set(CURL_FOUND TRUE CACHE INTERNAL "")
		set(CURL_INCLUDE_DIRS "${CURL_SOURCE_DIR}/include" CACHE INTERNAL "curl include dir")
